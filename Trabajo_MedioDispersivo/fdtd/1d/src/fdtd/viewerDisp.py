...
class Animator:
    ...
    def __init__(self, mesh, probe):
        ...
        ax1 = plt.axes(xlim=(gridE[0], gridE[-1]), ylim=(-10, 10))
        #ax1 = plt.axes(xlim=(gridE[0], gridE[-1]))
        ...
        plt.axvspan(0.3, 1, facecolor='r', alpha=0.1)  
        
        ani= animation.FuncAnimation(fig, animate, init_func=init,
            frames=len(probeTime), interval=10, blit=True)      
        
        plt.show()
        """ f = r"C:/Users/Goyo\Desktop/Condc_Lados.gif" 
